...
public class HexMapPanel extends JPanel {
  ...
  public HexMapPanel(final LayerListModel hexmodel) {
    super();
    setOpaque(false);
  ...
  public void setImage(final SVGImage image) {
    if (image != null) {
      image.setAntialiased(this.antialias);
    }
  ...
  public void setAntialiasing(final boolean flag) {
    ...
    if (this.mapImage.getSVGImage() != null) {
      this.mapImage.getSVGImage().setAntialiased(flag);
    }
  ...
  private void fireEvent(final int event) {
    for (final Component c : getComponents()) {
      if (c instanceof HexMapPanelComponent) {
        ((HexMapPanelComponent) c).onHexMapPanelInsideChange(this, event);
      }
    }
  }
  ...
  public LayerHexFieldRender getHexRenderer() {
