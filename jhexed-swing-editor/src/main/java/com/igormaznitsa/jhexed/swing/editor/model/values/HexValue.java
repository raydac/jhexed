package com.igormaznitsa.jhexed.swing.editor.model.values;
...
public abstract class HexValue {
  ...
  public static final HexValue NULL = new NullHexValue();
  
  public static HexValue readValue(final InputStream in) throws IOException {
  ...
  public HexValue(final HexValue val){
    this(val.name, val.comment, val.index);
  }
  
  public HexValue(final String name, final String comment, final int index){
    this.name = name == null ? "" : name;
    this.comment = comment == null ? "" : comment;
    this.index = index;
  }
  
  public HexValue(final InputStream in) throws IOException {
  ...
  public abstract HexValue cloneValue();
  ...
  public void load(final HexValue val) {
