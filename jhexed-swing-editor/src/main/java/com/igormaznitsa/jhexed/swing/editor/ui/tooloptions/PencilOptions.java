...
public class PencilOptions extends javax.swing.JPanel implements AppBus.AppBusListener, LayerIconList.LayerIconListListener {
  ...
  private void initComponents() {
    ...
    layerIconList.setBorder(javax.swing.BorderFactory.createTitledBorder("Value to draw"));
